    ...
    <div id="about" className="flex w-full">
      ...
      <div className="w-full">
        <div className="bg-[#3A4950]">
          <div className="p-[73px] pb-[120px] max-w-[768px] mr-auto">
            ...
            <p className="text-white mt-5">
              Мы – ведущий казахстанский производитель систем автоматизации для железных дорог. Наша
              миссия – создание инновационных решений, которые обеспечивают безопасность, скорость и
        ...
        <div className="p-[73px] bg-[#F0F4F7] text-[#8B9EA9] uppercase font-semibold">
          Среди наших клиентов – крупнейшие предприятия железнодорожной отрасли, включая АО «НК
          «КТЖ».
        </div>
      </div>
    </div>
