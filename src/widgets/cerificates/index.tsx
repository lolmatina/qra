    ...
    <div id='certificates' className='max-w-[1280px] px-5 mx-auto text-center py-24'>
      <div className="w-full col-span-1">
        ...
        <div className='w-[800px] mx-auto'>
          <CertificateSlider images=
            {
              imageFilenames.map((image, index) => (<div className='flex justify-center items-center w-full'>
                <img src={`certificates/${image}`} key={index} className='w-[400px] mx-auto'/>
              </div>))
            }
          />
        </div>
