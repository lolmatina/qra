...
const Services = () => {
  ...
  return (
    <div
      id="services"
      className="max-w-[1280px] mx-auto grid grid-cols-3 py-20 gap-8 items-stretch justify-stretch"
    >
      <div className="w-full col-span-1">
        <span className="text-[#6F7F89] uppercase font-semibold">Услуги</span>
        <h2 className="text-[#2D3941] mt-2 uppercase font-bold text-3xl">Комплексные решения</h2>
        <div className="bg-[#558D94] h-[2px] w-7 mt-2" />
        <p className="mt-6">Для модернизации железнодорожной инфраструктуры</p>
      </div>
